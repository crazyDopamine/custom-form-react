...
export declare class BaseField<P extends FieldProps, S extends FieldState> extends React.Component<
  P,
  S
> {
  constructor(props: P);
...
export declare function createField(
  ...
  new (props: FieldProps): {
    ...
    onBlur(v: any, ...args: any[]): void;
    context: any;
    setState<K extends string | number>(
      state:
        | FieldState
        | ((
            prevState: Readonly<FieldState>,
            props: Readonly<FieldProps>
          ) => FieldState | Pick<FieldState, K> | null)
        | Pick<FieldState, K>
        | null,
